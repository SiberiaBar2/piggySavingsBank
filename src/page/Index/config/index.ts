...
interface piggySate {
  ...
  produce: number,
  text: string,
  signState: signList[] // typeof brassSignList
}

const brassSignList: signList[] = [
  {
    state: 0,
    returnToken: 600
  },
...
export const piggyList: piggySate[] = [
  {
    name: '黄铜储蓄罐',
    price: 2000,
    produce: 6500,
